...
public class CryptoCurrencyServiceTest {
	...
	public void test_getProfitForGivenCurrency_WhenListSizeLessThanOne() throws ParseException {
		CryptoCurrencyResponseDto cryptoCurrencyResponseObj=	cryptoCurrencyService.getProfitForGivenCurrency(cryptoCurrTradeDetailsListOne);
	...
	public void test_getProfitForGivenCurrency_WhenListSizeMoreThanOne() throws ParseException {
		CryptoCurrencyResponseDto cryptoCurrencyResponseObj=	cryptoCurrencyService.getProfitForGivenCurrency(cryptoCurrTradeDetailsList);
	...
	@Test
	public void getFormatedTradeTime() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		CryptoCurrencyResponseDto cryptoCurrencyResponseObj=new CryptoCurrencyResponseDto();
		Method method = CryptoCurrencyServiceImpl.class.getDeclaredMethod("calculMaxProfitSellingTime", List.class, CryptoCurrencyResponseDto.class);
		method.setAccessible(true);
		cryptoCurrencyResponseObj= (CryptoCurrencyResponseDto) method.invoke(cryptoCurrencyService, cryptoCurrTradeDetailsList,cryptoCurrencyResponseObj);
		assertEquals("$37.01",cryptoCurrencyResponseObj.getSellingRate());
		assertEquals("$2.03",cryptoCurrencyResponseObj.getProfit());
	}
	@Test
	public void test_mapCryptoCurrTradeDetailsToDto() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		
		Method method = CryptoCurrencyServiceImpl.class.getDeclaredMethod("mapCryptoCurrTradeDetailsToDto", List.class);
		method.setAccessible(true);
		List<CryptoCurrTradeDetailsDto> temp= (List<CryptoCurrTradeDetailsDto>) method.invoke(cryptoCurrencyService, cryptoCurrTradeDetailsList);
	...
	@Test
	public void test_sortCryptoCurrTradeDetails() throws NoSuchMethodException, SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {

		Method method = CryptoCurrencyServiceImpl.class.getDeclaredMethod("sortCryptoCurrTradeDetails", List.class);
		method.setAccessible(true);
		List<CryptoCurrTradeDetails> temp= (List<CryptoCurrTradeDetails>) method.invoke(cryptoCurrencyService, cryptoCurrTradeDetailsList);
